...
def main(args):
    ...
    types_df['Types_Cat'] = types_df['Types'].cat.codes
    ...
    if args.input_model == 'ResNeXt50':
        ...
        my_extended_model = Myresnext50(my_pretrained_model= resnext50_pretrained, num_classes = len(types))
    #### train_iteration_1
...
parser.add_argument('--train_dir', type=str,
                    default='/data/aa-ssun2-cmp/DL_region/data/',
...
parser.add_argument('--save_checkpoints_dir', type = str,
                    default='/data/aa-ssun2-cmp/DL_region/checkpoints/',
                    help='save dir')
